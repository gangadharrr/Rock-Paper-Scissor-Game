...
var computerScore=0;
var playerScore=0;
document.getElementById('computer-score-result').innerHTML=computerScore;
document.getElementById('player-score-result').innerHTML=playerScore;
...
function gameAction(playerValue)
{
  ...
  document.getElementById("player-result-img").src=`assets/images/player-${playerValue}.jpg`;
  var ComputerChoice=getComputerChoice();
  document.getElementById("computer-result").innerHTML=ComputerChoice.charAt(0).toUpperCase()+ComputerChoice.slice(1);
  document.getElementById("computer-result-img").src=`assets/images/computer-${ComputerChoice}.jpg`;
